                                        ...
                                        OC:installApp(require("OC.TinuOC.defaultApps.Files"), function()
                                            OC:installApp(require("OC.TinuOC.defaultApps.Notepad"), function()
                                                OC:installApp(require("OC.TinuOC.defaultApps.Paint"), function()
                                                    OC:installApp(require("OC.TinuOC.defaultApps.Calculator"), function()
                                                        OC:installApp(require("OC.TinuOC.defaultApps.ResM"), function()
                                                            OC:installApp(require("OC.TinuOC.defaultApps.Screenshot"), function()
                                                                OC:installApp(require("OC.TinuOC.defaultApps.Snake"), function()
