local function updateAppsSearch(callback)
    ...
    {"paint", "OC.TinuOC.defaultApps.Paint"}, {"calculator", "OC.TinuOC.defaultApps.Calculator"}, {"resm", "OC.TinuOC.defaultApps.ResM"}, {"prt_sc", "OC.TinuOC.defaultApps.Screenshot"},
    {"snake", "OC.TinuOC.defaultApps.Snake"}}
